...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    ...
	    String string0 = nextDate0.run(8, 30, 1875);
	    assertEquals("8/31/1875", string0);
	}
	...
	public void testCreatesNextDate14() throws Throwable {
	    ...
	    String string0 = nextDate0.run(3, 3, 1879);
	    assertEquals("3/4/1879", string0);
	}
	...
	public void testRunWithPositive0() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(1257, 31, 1472);
	    assertEquals("invalid Input Date", string0);
	}
